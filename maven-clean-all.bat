...
@ECHO ON
CALL maven-clean-single.bat drumbeat-rdf 1>> %OUTPUT_FILE%

@ECHO ON
CALL maven-clean-single.bat drumbeat-rdf.modelfactory 1>> %OUTPUT_FILE%

@ECHO ON
CALL maven-clean-single.bat drumbeat-ifc.convert.stff2ifc 1>> %OUTPUT_FILE%

@ECHO ON
CALL maven-clean-single.bat drumbeat-ifc.processing.grounding.ifc 1>> %OUTPUT_FILE%

@ECHO ON
CALL maven-clean-single.bat drumbeat-ifc.convert.ifc2ld 1>> %OUTPUT_FILE%
