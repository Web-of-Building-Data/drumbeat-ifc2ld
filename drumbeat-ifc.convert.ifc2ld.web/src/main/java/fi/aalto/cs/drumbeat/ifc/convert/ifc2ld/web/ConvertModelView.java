		    ...
		    public void buttonClick(ClickEvent event) {
	    		try {
		    		...
		    		if (chbSaveFile.getValue()) {
				    	...
				    	Model outputModel = IfcApplication.convertIfcModelToJenaModel(fileName, null, context);
				    	// TODO: getBaseUri
				    	File outputFile = IfcApplication.exportJenaModelToFile(outputModel, null, fileName, rdfFormat, gzipOutputFile);
		    		...
		    		if (chbExportToVirtuoso.getValue() || chbExportToNeo4j.getValue()) {
		    			if (ntriplesOutputFile == null) {
					    	Model outputModel = IfcApplication.convertIfcModelToJenaModel(fileName, null, context);
					    	// TODO: getBaseUri
					    	ntriplesOutputFile = IfcApplication.exportJenaModelToFile(outputModel, null, fileName, RDFFormat.NTRIPLES, false);
		    			}		    			
			    	}
