...
//	private static final String NEO4J_FOLDER_PROPERTY_NAME = "neo4j.folder";
	...
	public static Model convertIfcModelToJenaModel(String fileName, Model jenaModel, Ifc2RdfConversionContext context) throws Exception {
		...
		Ifc2RdfExportUtil.exportModelToJenaModel(jenaModel, ifcModel, context);
		return jenaModel;
	}
	
	public static File exportJenaModelToFile(Model jenaModel, String baseUri, String fileName, RDFFormat rdfFormat, boolean gzipOutputFile) throws IOException {
		...
		RdfUtils.exportJenaModelToRdfFile(jenaModel, baseUri, outputModelFilePath, rdfFormat, gzipOutputFile);
