...
//		
//		converter = new Ifc2RdfConverter(context);
...
//		entityResource.addProperty(RDF.type, createUriResource(converter.formatTypeName(entityTypeInfo)));
//		
...
////				jenaModel.add(entityResource, RDF.type, converter.createUriResource(
...
////						entityResource,
////						RDF.type,
////						converter.createUriResource(converter.formatOntologyName(Ifc2RdfVocabulary.IFC.SUPER_ENTITY)));				
////			}		
////			
////			
////			if (entity.hasName()) {
...
////					jenaModel.add(
////							entityResource,
////							converter.createUriResource(converter.formatOntologyName(Ifc2RdfVocabulary.IFC.RAW_NAME)).as(Property.class),
...
//				jenaModel.add(
//				entityResource,
//				converter.createUriResource(converter.formatOntologyName(Ifc2RdfVocabulary.IFC.PROPERTY_DEBUG_MESSAGE)).as(Property.class),
//						jenaModel.createTypedLiteral(debugMessage));				
//			}
//			
//			jenaModel.add(
//					entityResource,
//					converter.createUriResource(converter.formatOntologyName(Ifc2RdfVocabulary.IFC.PROPERTY_LINE_NUMBER_PROPERTY)).as(Property.class),
...
//		
//		Resource listResource = converter.createAnonResource();
//		Resource typeResource = converter.createUriResource(converter.formatTypeName(collectionTypeInfo)); 
...
////		listResource.addProperty(Ifc2RdfVocabulary.EXPRESS.itemType, converter.createUriResource(converter.formatTypeName(itemTypeInfo)));
//		
//		for (int i = 0; i < nodeList.size(); ++i) {
//			Resource slotResource = converter.createAnonResource();
...
//		if (entity.hasName()) {
//			return converter.createUriResource(converter.formatModelName(entity.getName()));
//		} else {
//			return converter.createAnonResource(String.format(Ifc2RdfVocabulary.IFC.BLANK_NODE_ENTITY_URI_FORMAT, entity.getLineNumber()));
//		}
//	}
//	
//	public Property convertAttributeInfoToResource(IfcAttributeInfo attributeInfo) {
//		return converter.createUriResource(converter.formatAttributeName(attributeInfo)).as(Property.class);		
//	}
//	
//}
